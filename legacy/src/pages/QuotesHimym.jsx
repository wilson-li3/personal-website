        ...
        <div className="quotes-container">
          <ul className="about-list quotes-list">
            <li>
              ...
              <div className="quote-thought">This is my favorite quote from the entire show. And it’s true. What’s there to celebrate without the people who saw you through ups and downs</div>
            </li>
            <li>
              ...
              <div className="quote-thought">It's easy to let people slip away, but when you find someone worth keeping, you have to make an effort to hold on to them.</div>
            </li>
            <li>
              ...
              <div className="quote-thought">dont tunnel vision on what you think you want. be open to the possibilities</div>
            </li>
            <li>
              <div className="quote-text">– "sometimes things have to fall apart to make way for better things"</div>
              <div className="quote-thought">failing is part of the process</div>
            </li>
            <li>
              <div className="quote-text">– "kids, you can't cling to the past because no matter how hard you hold on, it's already gone"</div>
              <div className="quote-thought">let go of what was and embrace what is</div>
            </li>
            <li>
              ...
              <div className="quote-thought">we're here for a fun time not a long time</div>
            </li>
            <li>
              ...
              <div className="quote-thought">when the right person shows up, you'll know</div>
            </li>
          </ul>
        </div>
      </div>

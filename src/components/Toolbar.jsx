  ...
  return (
    <div className="toolbar">
      ...
      <div className="toolbar-icons">
        <a href="https://github.com/wilson-li3" target="_blank" rel="noopener noreferrer" className="toolbar-icon" title="GitHub">
        ...
        <a href="https://www.linkedin.com/in/wilsonli3" target="_blank" rel="noopener noreferrer" className="toolbar-icon" title="LinkedIn">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <a href="https://devpost.com/wilson-li3?ref_content=user-portfolio&ref_feature=portfolio&ref_medium=global-nav" target="_blank" rel="noopener noreferrer" className="toolbar-icon" title="DevPost">
          <svg width="16" height="16" viewBox="0 0 64 64" fill="none">
            <path d="M48.7,4.8H15.3L0,32l15.7,27.2h33.1L64,32L48.7,4.8z" fill="currentColor"/>
        ...
        <a href="mailto:wyli@uwaterloo.ca" className="toolbar-icon" title="Mail">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <Link to="/photos" className="toolbar-icon" title="Photos">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
